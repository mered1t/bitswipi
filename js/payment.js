...
let to_copy = crypto_list[networkSend];
let paymentWallet = crypto_list[networkSend];
...
payWAlletEl.innerHTML = paymentWallet.substr(0, 10) + "...." + paymentWallet.substr(-10);
receiveDataEl.innerHTML = receiveDataText;
receiveWAlletEl.innerHTML = receive_wallet.substr(0, 10) + "...." + receive_wallet.substr(-10);
